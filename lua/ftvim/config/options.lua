...
vim.g.ftvim_picker = "auto"

-- FtVim root dir detection
-- Each entry can be:
...
-- FtVim automatically configures lazygit:
...
-- Options for the FtVim statuscolumn
vim.g.ftvim_statuscolumn = {
...
if vim.fn.has("nvim-0.10") == 1 then
  ...
  opt.foldexpr = "v:lua.require'ftvim.util'.ui.foldexpr()"
  opt.foldmethod = "expr"
  opt.foldtext = ""
else
  opt.foldmethod = "indent"
  opt.foldtext = "v:lua.require'ftvim.util'.ui.foldtext()"
end
