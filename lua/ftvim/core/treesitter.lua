...
function M.setup()
	...
	local opts = vim.deepcopy(ftvim.builtin.treesitter)
	...
	if ftvim.builtin.treesitter.on_config_done then
		ftvim.builtin.treesitter.on_config_done(treesitter_configs)
	end
